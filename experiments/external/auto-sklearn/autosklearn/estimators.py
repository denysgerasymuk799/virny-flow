...
class AutoSklearnEstimator(BaseEstimator):
    def __init__(
        ...
        # If we use max_total_pipelines_num for execution budget, set time_left_for_this_task to a long period (2 days)
        if max_total_pipelines_num is not None:
            time_left_for_this_task = 60 * 60 * 24 * 2
            disable_progress_bar = True
            max_total_pipelines_num += 1 # Add a dummy run that auto-sklearn has before running SMBO
        ...
        self.max_total_pipelines_num = max_total_pipelines_num
    ...
    def build_automl(self):
        ...
        automl = self._get_automl_class()(
            ...
            max_total_pipelines_num=self.max_total_pipelines_num,
