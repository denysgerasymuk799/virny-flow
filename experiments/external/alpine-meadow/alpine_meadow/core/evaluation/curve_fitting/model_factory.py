# Adopted from https://github.com/microsoft/nni/blob/master/src/sdk/pynni/nni/curvefitting_assessor/model_factory.py
# flake8: noqa
# pylint: skip-file
...
from .curve_functions import *  # pylint: disable=wildcard-import,unused-wildcard-import

# Number of curve functions we prepared, more details can be found in "curve_functions.py"
NUM_OF_FUNCTIONS = 12
...
class CurveModel:
    ...
    """
    def __init__(self, target_pos, logger):
    ...
    def fit_theta(self):
        ...
        for i in range(NUM_OF_FUNCTIONS):
            ...
            try:
                ...
                self.logger.critical("Exceptions in fit_theta: %s", exception)
    ...
    def filter_curve(self):
        ...
        self.logger.info('List of effective model: %s', self.effective_model)
