...
from alpine_meadow.primitives.feature_processing.one_hot_utils import OneHotEncoder
...
metafeatures_lock = threading.Lock()
    ...
    def _calculate(self, X, y, categorical):
        ...
        if len(y.shape) == 1 or y.shape[1] == 1:
            ...
            if min_count < 2:
                ...
                kf = sklearn.model_selection.StratifiedKFold(n_splits=min(min_count, 5))
        else:
            kf = sklearn.model_selection.KFold(n_splits=5)
        accuracy = 0.
