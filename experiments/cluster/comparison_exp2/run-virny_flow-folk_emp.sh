...
declare -a job_configs=(
    "comparison_exp2 folk_emp virny_flow 32 32 96 1 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 2 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 3 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 4 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 5 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 6 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 7 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 8 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 9 0.5 0.5 0.0 vf 3600 np2969"
    "comparison_exp2 folk_emp virny_flow 32 32 96 10 0.5 0.5 0.0 vf 3600 np2969"
)
