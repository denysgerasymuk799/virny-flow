...
from virny_flow.configs.constants import EXP_PROGRESS_TRACKING_COLLECTION_NAME, TaskStatus, STAGE_SEPARATOR, NO_FAIRNESS_INTERVENTION
...
async def create_execution_plan(db_client):
    ...
    await db_client.write_records_into_db(collection_name=EXP_PROGRESS_TRACKING_COLLECTION_NAME,
                                          records=records,
                                          static_values_dct={
